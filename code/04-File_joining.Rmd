...
#record transcripts lost in this step
...
# save files for unidentified and identified
#record nrow for each ID and unID, put in notebook post
#save count matrices for dds's as files
