...
genes_to_plot_hspG <- genes_to_plot_hspG[-16]
...
labels_hifF <- c(
  "Aryl hydrocarbon receptor nuclear translocator (Class E basic helix-loop-helix protein 2) (Hypoxia-inducible factor 1-beta)",
...
genes_to_plot_peroxF <- genes_to_plot_peroxF[-10]
...
genes_to_plot_peroxG <- genes_to_plot_peroxG[-12]
