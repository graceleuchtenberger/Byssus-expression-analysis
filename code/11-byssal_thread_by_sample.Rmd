...
foot_byss_GCM_2 %>%
  ...
  my_theme+
  scale_x_discrete(labels = c("Foot protein 10", "Foot protein 11", "Foot protein 12", "Foot protein 13", "Foot protein 14", "Foot protein 15", "Foot protein 17", expression(paste("Foot protein 2 (", italic("M. edulis"), ")")), "Foot protein-4 variant-1"))
