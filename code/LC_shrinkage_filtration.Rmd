...
#saving gene counts as a result of each filtration step
gene_counts_GDO_LC <- as.data.frame(c(nrow(countmatrix_GDO),nrow(dds10_filt),(nrow(countmatrix_GDO)-nrow(dds10_filt)),nrow(GDO_LC_normal_res_table),nrow(GDO_LC_apeglm_res_table),nrow(GDO_LC_ashr_res_table),nrow(GDO_LC_siggenes_apeglm),nrow(GDO_LC_sig_genes_ashr),nrow(GDO_LC_sig_genes_normal)))
