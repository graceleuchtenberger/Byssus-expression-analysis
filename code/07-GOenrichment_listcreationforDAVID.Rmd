...
length(uniprot_BG_DAVID) #6365 with UNIPROT id's 
uniprot_BG_DAVID_unique <- unique(uniprot_BG_DAVID)
length(uniprot_BG_DAVID_unique) #5547
...
length(FDO_sigs_uniprot) # 291
FDO_sigs_uniprot_unique <- unique(FDO_sigs_uniprot)
length(FDO_sigs_uniprot_unique) #225
...
length(GDO_sigs_uniprot) # 155
GDO_sigs_uniprot_unique <- unique(GDO_sigs_uniprot)
length(GDO_sigs_uniprot_unique) #126
