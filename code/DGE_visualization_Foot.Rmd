...
res_tableOA        <- results(dds4, contrast=contrast_listOA, alpha = 0.05)
...
res_tableOW        <- results(dds5, contrast=contrast_listOW, alpha = 0.05)
...
res_tableDO        <- results(dds6, contrast=contrast_listDO, alpha = 0.05)
...
res_tablecon        <- results(dds7, contrast=contrast_listcon, alpha = 0.05)
